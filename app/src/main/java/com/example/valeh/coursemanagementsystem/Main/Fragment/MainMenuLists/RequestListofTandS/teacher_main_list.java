...
public class teacher_main_list extends BaseFragment {
     ...
     * @return A new instance of fragment teacher_main_list.
     */
    // TODO: Rename and change types and number of parameters
    public static teacher_main_list newInstance(String param1, String param2) {
        teacher_main_list fragment = new teacher_main_list();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        P_TYPE_N = PreferenceManager.getDefaultSharedPreferences(getContext()).getInt("myRolee1", 0);
        P_STAT_N = PreferenceManager.getDefaultSharedPreferences(getContext()).getInt("myStatus1", 1);
//
...
//        Toast.makeText(getActivity(),String.valueOf(P_TYPE_N),Toast.LENGTH_SHORT).show();
        ...
        Call<ArrayList<TeachersAllModel>> call = api.getAllTeachers(tokken,P_TYPE_N,P_STAT_N);
